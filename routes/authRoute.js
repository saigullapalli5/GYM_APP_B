...
import { makeAdminController, removeAdminController, listUsersController } from "../controlllers/adminController.js";
...
router.put("/admin/users/:userId/make-admin", requireSignIn, isAdmin, makeAdminController);
router.put("/admin/users/:userId/remove-admin", requireSignIn, isAdmin, removeAdminController);
